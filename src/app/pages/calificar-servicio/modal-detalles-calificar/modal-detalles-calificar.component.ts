...
@Component({
  selector: 'app-modal-detalles-calificar',
  templateUrl: './modal-detalles-calificar.component.html',
  styleUrls: ['./modal-detalles-calificar.component.css']
})
export class ModalDetallesCalificarComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any) { 
    ...
    const subtotal=data.costo_servicio+data.costo_revision
