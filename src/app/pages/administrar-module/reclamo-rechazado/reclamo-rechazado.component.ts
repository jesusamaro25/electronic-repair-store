...
@Component({
  selector: 'app-reclamo-rechazado',
  templateUrl: './reclamo-rechazado.component.html',
  styleUrls: ['./reclamo-rechazado.component.css']
})
export class ReclamoRechazadoComponent implements OnInit {
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('plantillaNotificacion/7').then((result) => {
    ...
    if (this.textoControl.valid && this.tituloControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          this.servicio.putFormData(datos,'plantillaNotificacion','7').then((result) => {
