...
@Component({
  ...
  templateUrl: './correo-registro.component.html',
  styleUrls: ['./correo-registro.component.css']
})
export class CorreoRegistroComponent implements OnInit {
  resultado: any;
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('plantillaNotificacion/15').then((result) => {
    ...
    if (this.textoControl.valid && this.tituloControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          this.servicio.putFormData(datos,'plantillaNotificacion','15').then((result) => {
