...
@Component({
  selector: 'app-retirar-equipo',
  templateUrl: './retirar-equipo.component.html',
  styleUrls: ['./retirar-equipo.component.css']
})
export class RetirarEquipoComponent implements OnInit {
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('plantillaNotificacion/6').then((result) => {
    ...
    if (this.textoControl.valid && this.tituloControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          this.servicio.putFormData(datos,'plantillaNotificacion','6').then((result) => {
