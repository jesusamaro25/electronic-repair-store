...
@Component({
  selector: 'app-reclamo-asignado',
  templateUrl: './reclamo-asignado.component.html',
  styleUrls: ['./reclamo-asignado.component.css']
})
export class ReclamoAsignadoComponent implements OnInit {
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('plantillaNotificacion/10').then((result) => {
    ...
    if (this.textoControl.valid && this.tituloControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          this.servicio.putFormData(datos,'plantillaNotificacion','10').then((result) => {
