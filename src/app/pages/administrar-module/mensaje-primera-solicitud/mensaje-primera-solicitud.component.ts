...
@Component({
  selector: 'app-mensaje-primera-solicitud',
  templateUrl: './mensaje-primera-solicitud.component.html',
  styleUrls: ['./mensaje-primera-solicitud.component.css']
})
export class MensajePrimeraSolicitudComponent implements OnInit {
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('mensaje/1').then((result) => {
    ...
    if (this.textoControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          this.servicio.putFormData(datos,'mensaje','1').then((result) => {
