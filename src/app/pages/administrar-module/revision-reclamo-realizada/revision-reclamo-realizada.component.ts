...
@Component({
  selector: 'app-revision-reclamo-realizada',
  templateUrl: './revision-reclamo-realizada.component.html',
  styleUrls: ['./revision-reclamo-realizada.component.css']
})
export class RevisionReclamoRealizadaComponent implements OnInit {
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('plantillaNotificacion/8').then((result) => {
    ...
    if (this.textoControl.valid && this.tituloControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          this.servicio.putFormData(datos,'plantillaNotificacion','8').then((result) => {
