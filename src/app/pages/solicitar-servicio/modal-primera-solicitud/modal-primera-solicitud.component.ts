...
@Component({
  selector: 'app-modal-primera-solicitud',
  templateUrl: './modal-primera-solicitud.component.html',
  styleUrls: ['./modal-primera-solicitud.component.css']
})
export class ModalPrimeraSolicitudComponent implements OnInit {
 ...
 /** list of banks */
  ...
  constructor(public servi: GeneralServiceService,public dialogRef: MatDialogRef<ModalPrimeraSolicitudComponent>,public alert: funciones) {  }

  ngOnInit() {

    this.servi.getAll('mensaje/1').then((result: any) => {
    ...
    this.mensaje="Gracias por utilizar nuestros servicios, antes de que hagas tu primera solicitud por favor cuentanos tus preferencias"
