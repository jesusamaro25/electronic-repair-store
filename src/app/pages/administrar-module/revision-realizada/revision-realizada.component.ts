...
@Component({
  selector: 'app-revision-realizada',
  templateUrl: './revision-realizada.component.html',
  styleUrls: ['./revision-realizada.component.css']
})
export class RevisionRealizadaComponent implements OnInit {
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('plantillaNotificacion/3').then((result) => {
    ...
    if (this.textoControl.valid && this.tituloControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          this.servicio.putFormData(datos,'plantillaNotificacion','3').then((result) => {
