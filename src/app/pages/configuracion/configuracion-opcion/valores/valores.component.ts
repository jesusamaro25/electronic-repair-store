...
export class ValoresComponent implements OnInit {
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('empresa').then((result) => {
      ...
      this.imagen= this.resultado.data.urlImagenObjetivoGeneral;
      this.textoControl.setValue(this.resultado.data.objetivoGeneral);
    ...
    if (this.textoControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          datos.append('objetivoGeneral',this.textoControl.value);
          if (this.imagenSeleccionada != null) 
          {
            datos.append('imagenObjetivoGeneral', this.imagenSeleccionada);
          }
