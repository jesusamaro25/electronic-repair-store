...
@Component({
  selector: 'app-reclamo-aprobado',
  templateUrl: './reclamo-aprobado.component.html',
  styleUrls: ['./reclamo-aprobado.component.css']
})
export class ReclamoAprobadoComponent implements OnInit {
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('plantillaNotificacion/5').then((result) => {
    ...
    if (this.textoControl.valid && this.tituloControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          this.servicio.putFormData(datos,'plantillaNotificacion','5').then((result) => {
