...
@Component({
  selector: 'app-servicio-asignado',
  templateUrl: './servicio-asignado.component.html',
  styleUrls: ['./servicio-asignado.component.css']
})
export class ServicioAsignadoComponent implements OnInit {
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('plantillaNotificacion/9').then((result) => {
    ...
    if (this.textoControl.valid && this.tituloControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          this.servicio.putFormData(datos,'plantillaNotificacion','9').then((result) => {
