...
@Component({
  selector: 'app-solicitud-aprobada',
  templateUrl: './solicitud-aprobada.component.html',
  styleUrls: ['./solicitud-aprobada.component.css']
})
export class SolicitudAprobadaComponent implements OnInit {
  ...
  CargarDatos(){
    ...
    this.servicio.getAll('plantillaNotificacion/1').then((result) => {
    ...
    if (this.textoControl.valid && this.tituloControl.valid){
      ...
      Swal.fire({
        ...
        cancelButtonText: 'Cancelar'
          ...
          this.servicio.putFormData(datos,'plantillaNotificacion','1').then((result) => {
